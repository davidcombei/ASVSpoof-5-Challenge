...
def main(outdir, metadata_file,indir):
    ...
    if feats:
        ...
        np.save(os.path.join(outdir, '400x768_train_wavLMV3.npy'), feats)
    else:
...
if __name__ == '__main__':
    ...
    indir = '/home/asvspoof/DATA/asvspoof24/flac_T/'
    outdir = '/home/asvspoof/DATA/asvspoof24/wavLM-base'
    metadata_file = '/home/asvspoof/DATA/asvspoof24/metadata/ASVspoof5.train_MEDIUM.metadata.txt'
