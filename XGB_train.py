...
def main():
    ...
    xgb = XGBClassifier(n_estimators=100, max_depth=3, learning_rate=0.1, objective='binary:logistic', use_label_encoder=False, eval_metric='logloss')
    ...
    model_save_path = "saved_models/asv_wavLMV3_XGB.pkl"
